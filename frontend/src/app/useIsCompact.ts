...
/**
 * The single breakpoint the shell folds at. Below it the sidebar becomes a drawer, the member
 * panel becomes an overlay, and the header stacks its search onto a second row.
 *
